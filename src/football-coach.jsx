...
export default function FootballCoach() {
  ...
  const analytics = useMemo(() => {
    ...
    const emptyStats = () => ({
      attempts: 0, receptions: 0, recGain: 0, recLoss: 0,
      incompletions: 0, runs: 0, runGain: 0, runLoss: 0,
      tds: 0, ints: 0, drops: 0, throwAways: 0, sacks: 0, xp1: 0, xp2: 0, xp3: 0, yards: 0,
    });
                  ...
                  <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12, minWidth: 900 }}>
                    <thead>
                      <tr style={{ background: THEME.buttonBg }}>
                        {["Play Code","Att","Rec","Cmp%","TD%","INT%","Rec+","Rec-","Inc","Runs","Run+","Run-","TDs","INTs","Drops","T/A","Sacks","XP-1","XP-2","XP-3","Yards"].map((h, i) => (
                    ...
                    <tbody>
                      ...
                      <tr style={{ borderTop: "2px solid #e5e7eb", background: "#f0f4f8" }}>
                        ...
                        {(() => {
                          ...
                          return [ct.attempts, ct.receptions, cmpPct, tdPct, intPct, ct.recGain, ct.recLoss, ct.incompletions, ct.runs, ct.runGain, ct.runLoss, ct.tds, ct.ints, ct.drops, ct.throwAways, ct.sacks, ct.xp1, ct.xp2, ct.xp3, ct.yards].map((v, i) => (
